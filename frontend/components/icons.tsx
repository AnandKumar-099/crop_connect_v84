...
export const UserGroupIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.51.054.994.097 1.482.127a6 6 0 011.289.97c.545.447.991.954 1.395 1.482m-7.5-2.962a3.375 3.375 0 00-4.125-2.962c-1.253.134-2.373.486-3.375.97m-7.5 0v-.625c0-.621.504-1.125 1.125-1.125H15M9.75 15.375c.24-.015.48-.03.72-.052m-7.5 0a3.375 3.375 0 00-4.125-2.962c-1.253.134-2.373.486-3.375.97m7.5 0v-.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v.625m-7.5 0a3.375 3.375 0 00-4.125-2.962c-1.253.134-2.373.486-3.375.97m16.5 0a3.375 3.375 0 00-4.125-2.962c-1.253.134-2.373.486-3.375.97m-12.5-3.375a3.375 3.375 0 01-3.375-3.375V6.75a3.375 3.375 0 013.375-3.375h5.25a3.375 3.375 0 013.375 3.375v3a3.375 3.375 0 01-3.375 3.375h-5.25z" /></svg>
);

export const PresentationChartLineIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h12M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-12a2.25 2.25 0 01-2.25-2.25V3m12.75 0v6.75a2.25 2.25 0 01-2.25 2.25H9.75a2.25 2.25 0 01-2.25-2.25V3m4.5 0v6.75a2.25 2.25 0 01-2.25 2.25H9.75a2.25 2.25 0 01-2.25-2.25V3m9 15l-3-3m0 0l-3 3m3-3v-6m-1.5 9H5.625c-.621 0-1.125-.504-1.125-1.125V18" /></svg>
);
...
export const LightBulbIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-11.39a6.01 6.01 0 00-3 0 6.01 6.01 0 001.5 11.39zm0 0a2.25 2.25 0 01-2.25 2.25m2.25-2.25a2.25 2.25 0 002.25 2.25m-2.25 2.25V18m-9-5.25h18" /></svg>
);
